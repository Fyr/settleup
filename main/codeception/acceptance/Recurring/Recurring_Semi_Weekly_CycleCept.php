...
$I->wantTo('check the assigned recurring payments and deductions for settlement cycle is Semi-Weekly');
...
$Settlement->addSemiSettlement(Input_Data::$settlement__Semi_Weekly_Cycle, Input_Data::$settlement_Start_Date, Input_Data::$settlement_Processing_Deadline, Input_Data::$settlement_Disbursement_Terms, 'Monday', 'Thursday');
