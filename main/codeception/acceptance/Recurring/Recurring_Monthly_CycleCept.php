...
$I->wantTo('check the assigned recurring compensations and deductions for settlement cycle is Monthly');
...
$Settlement->addSettlement(Input_Data::$settlement__Monthly_Cycle, Input_Data::$settlement_Start_Date, Input_Data::$settlement_Processing_Deadline, Input_Data::$settlement_Disbursement_Terms);
//Add payments
