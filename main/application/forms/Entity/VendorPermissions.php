...
class Application_Form_Entity_VendorPermissions extends Application_Form_Base
{
    public function init()
    {
        $this->setName('carrier_permissions');
        parent::init();
        ...
        $reserve_account_contractor_view->setLabel('View Contractor Reserve Accounts');
