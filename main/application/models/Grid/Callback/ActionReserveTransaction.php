...
class Application_Model_Grid_Callback_ActionReserveTransaction
{
    ...
    public function body()
    {
        if (
            ...
            return '<a class="btn btn-primary" href="/reserve_transactions/edit/id/' . $this->row['id'] . '"><i class="icon-pencil icon-white"></i> Edit</a>' . ' <a class="btn btn-danger confirm" confirm-type="Deletion" href="/reserve_transactions/delete/id/' . $this->row['id'] . '"><i class="icon-trash icon-white"></i> Delete</a>';
        }
    }
