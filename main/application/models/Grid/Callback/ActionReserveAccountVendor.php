...
class Application_Model_Grid_Callback_ActionReserveAccountVendor
{
    ...
    public function body()
    {
        ...
        if (($raEntityTypeId == Application_Model_Entity_Entity_Type::TYPE_CARRIER && $user->hasPermission(
        ...
        } elseif (($raEntityTypeId == Application_Model_Entity_Entity_Type::TYPE_CARRIER && $user->hasPermission(
