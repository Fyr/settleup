...
class Application_Model_Grid_Header_PaymentSetups implements Application_Model_Grid_Header_HeaderInterface
{
    public function getData($grid, $view)
    {
        ...
        $delete = [
            ...
            "action-type" => "delete",
            "url" => $view->url(['controller' => 'payments_setup', 'action' => 'multiaction'], null, true),
        ];
        ...
        $add = [
            ...
            "url" => $view->url(['controller' => 'payments_setup', 'action' => 'new',], null, true),
        ];
