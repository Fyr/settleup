...
class Application_Model_Grid_Header_ReserveAccountContractor implements Application_Model_Grid_Header_HeaderInterface
{
    public function getData($grid, $view)
    {
        $buttons = [
            'add' => [
                ...
                "url" => '/reserve_accountcontractor/new',
            ],
            'upload' => [
                'caption' => 'Upload',
                'button_class' => 'btn-success',
